  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="jk" name="jk" 
        value="L" type="radio" class="form-control" <?php if(isset($_GET["idedit"])) {if($row["jk"] == "L"){echo "checked";}} ?>> <label for="lakilaki" class="mt-2">Laki - laki</label>
        <input id="jk" name="jk" 
        value="P" type="radio" class="form-control" <?php if(isset($_GET["idedit"])) {if($row["jk"] == "P"){echo "checked";}} ?>> <label for="Perempuan" class="mt-2">Perempuan</label>
      </div>
    </div>
  </div>
  <div class="form-group row">
